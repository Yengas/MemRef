...
/***/ function(module, exports, __webpack_require__) {
	...
	window.addEventListener("DOMContentLoaded", function () {
		chrome.storage.local.get("history", function (data) {
			var history = Object.keys(data.history).map(function (key) {
				return _extends({}, data.history[key], {
			...
			_reactDom2.default.render(React.createElement(_App2.default, { history: history, perPage: 25 }), document.body);
		});
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactPaginate = __webpack_require__(5);
	...
	var App = function (_React$Component) {
		...
		function App(props) {
			...
			var filtered = _this.getFiltered(props.history, 'all');
			_this.state = {
				logs: _this.getLogRange(filtered, 0, props.perPage), // Shown logs
				filtered: filtered, // Filtered logs by ref
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					this.state.filters.map(function (filter) {
						return filter == _this2.state.selected.filter ? _react2.default.createElement(
							'span',
							null,
							filter
						) : _react2.default.createElement(
							'a',
							{ href: '#', onClick: _this2.onFilterClick },
							filter
						);
					}),
					_react2.default.createElement(
						...
						null,
						'Current Page: ',
						this.state.selected.page + 1
					),
					_react2.default.createElement(_LinkList2.default, { logs: this.state.logs }),
	...
	var _initialiseProps = function _initialiseProps() {
		...
		this.getLogRange = function (logs, page, perPage) {
			var offset = Math.ceil(page * perPage);
			if (offset < 0 || offset >= logs.length) return [];

			return logs.slice(offset, offset + perPage);
		};

		this.getFiltered = function (logs, selected) {
			return logs.filter(function (log) {
				return selected == 'all' || log.ref == selected;
			});
		};

		this.handlePageClick = function () {
			var data = arguments.length <= 0 || arguments[0] === undefined ? { selected: 0 } : arguments[0];

			if (data.selected < 0) return false;
			var logs = _this3.getLogRange(_this3.state.filtered, data.selected, _this3.props.perPage);
			if (logs.length == 0) return false;

			_this3.setState({
				selected: _extends({}, _this3.state.selected, { page: data.selected }),
				logs: logs
			});
			window.scrollTo(0, 0);
		};
		...
		this.onKeyPressed = function (e) {
			...
			_this3.handlePageClick({ selected: _this3.state.selected.page + (e.which == 39 ? 1 : -1) });
		};

		this.onFilterClick = function (e) {
			var filter = e == undefined ? 'all' : e.target.innerText;
			var filtered = _this3.getFiltered(_this3.props.history, filter);

			_this3.setState({ selected: { page: 0, filter: filter }, filtered: filtered, logs: _this3.getLogRange(filtered, 0, _this3.props.perPage) });
		};
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PaginationBoxView = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PaginationListView = __webpack_require__(8);
	...
	var PaginationBoxView = function (_Component) {
	  ...
	  _createClass(PaginationBoxView, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement('ul', { className: this.props.containerClassName }, _react2.default.createElement('li', { onClick: this.handlePreviousPage, className: previousClasses }, _react2.default.createElement('a', { href: '', className: this.props.previousLinkClassName }, this.props.previousLabel)), _react2.default.createElement('li', null, _react2.default.createElement(_PaginationListView2.default, {
	        ...
	        disabledClassName: this.props.disabledClassName })), _react2.default.createElement('li', { onClick: this.handleNextPage, className: nextClasses }, _react2.default.createElement('a', { href: '', className: this.props.nextLinkClassName }, this.props.nextLabel)));
	    }
	  }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddonsCreateFragment = __webpack_require__(9);
	...
	var PaginationListView = function (_Component) {
	  ...
	  _createClass(PaginationListView, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement('ul', { className: this.props.subContainerClassName }, (0, _reactAddonsCreateFragment2.default)(items));
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(10).create;
	...
	var PageView = function (_React$Component) {
	  ...
	  _createClass(PageView, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement('li', { className: cssClassName }, _react2.default.createElement('a', _extends({}, this.props, { href: '', className: linkClassName }), this.props.page));
	    }
	  }]);
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					this.props.logs.map(function (log) {
						var current_date = log.date.toLocaleDateString();
						...
						if (previous != current_date) {
							...
							return _react2.default.createElement(
								...
								_react2.default.createElement(_Link2.default, log)
							);
						}

						return _react2.default.createElement(_Link2.default, log);
					})
				);
			}
		}]);
